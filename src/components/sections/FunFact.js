        ...
        <div className="row fuct-items">
          ...
          <div className="col col-d-3 col-t-3 col-m-6 border-line-v">
            <div className="fuct-item">
              ...
              <div className="name">2 Catapults Built</div>
            </div>
          </div>
          {/* fuct item */}
          <div className="col col-d-3 col-t-3 col-m-6 border-line-v">
            <div className="fuct-item">
              ...
              <div className="name">8 Consecutive Halloween Costume Contest Wins</div>
            </div>
          </div>
          {/* fuct item */}
          <div className="col col-d-3 col-t-3 col-m-6 border-line-v">
            <div className="fuct-item">
              ...
              <div className="name">13 Crossword Puzzles Created</div>
            </div>
          </div>
          {/* fuct item */}
          <div className="col col-d-3 col-t-3 col-m-6 border-line-v">
            <div className="fuct-item">
              ...
              <div className="name">3 RC Boats Made From Scratch</div>
            </div>
          </div>
          <div className="clear" />
        </div>
